  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="chrome-text text-7xl font-bold">404</h1>
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="chrome-fill inline-flex items-center justify-center rounded-full px-5 py-2 text-sm font-semibold"
          >
            Go home
          </Link>
        </div>
